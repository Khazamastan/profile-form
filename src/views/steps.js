...
import { routerTransitionTo} from '../components/utils';
...
export default class MultiStep extends Component {
  ...
  next() {
    actions.validateStep(this.state.compState + 1, function(){
  ...
  render() {
    ...
    return (
      <div className="container" onKeyDown={this.handleKeyDown}>
        ...
        <div className="row text-center mt-20 mb-40" style={this.props.showNavigation ? {} : this.hidden}>
          <button style={this.state.showPreviousBtn ? {} : this.hidden}
                  className="multistep__btn--prev mr-20"
